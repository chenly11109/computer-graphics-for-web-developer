...
export default function Notes() {
    return <main className="flex flex-row gap-20 m-5">
        ...
        <section className="w-1/6">
            <NavLink className={({ isActive }) => isActive ? "underline block font-bold" : "block hover:underline"} to=".">Introduction</NavLink>
            ...
            <div className="ml-5">
                ...
                <NavLink className={({ isActive }) => isActive ? "underline block font-bold" : "block hover:underline"} to="09LightSource">Light Source</NavLink>
            </div>
        </section>
        <Outlet />
    </main>
